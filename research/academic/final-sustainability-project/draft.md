...
המיזם מציע להתקין במוצאי הניקוז רכבת טיפול משולבת: לכידה והשקעה ראשונית, ולאחריה סינון באמצעות מדיה פילטר או ביופילטר בהתאם לשטח הזמין בכל מוצא. הפתרון נשען על שתי טכנולוגיות שהוכחו בשדה. מחקר ארוך טווח בדרום קווינסלנד הראה הפחתה של כ-80% במוצקים מרחפים, כ-60% בזרחן וכ-50% במתכות כבדות, ללא סימני רוויה לאחר יותר מארבע שנות תפעול (Drapper & Hornbuckle, 2018). בישראל, הביופילטר הראשון הוקם בכפר סבא ומטפל ב-4,000 עד 7,000 מ"ק בשנה (קק"ל, 2024).
...
על פי פרסומי המשרד להגנת הסביבה, כ-75% מהזיהום המגיע לים מקורו במקורות יבשתיים, ובכללם שפכים ממפעלי תעשייה, נחלים מזוהמים, תקלות במערכות הביוב ומערכות ניקוז עירוניות (מבקר העירייה, 2021). זיהום מי הים מתחלק לשני סוגים בעלי השלכות שונות. זיהום מיקרוביאלי, שמשמעו נוכחות חיידקים ממקור צואתי או חיידקים פתוגניים, פוגע בעיקר בבריאות המתרחצים. זיהום כימי פוגע בעיקר במערכת האקולוגית הימית. נגר עירוני מייצר את שני הסוגים במקביל, ולכן הטיפול בו נוגע בשני צירי הנזק בו זמנית.
