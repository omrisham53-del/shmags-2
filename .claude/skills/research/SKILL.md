---
name: research
description: Research assistant that calls Groq API (free) with context-appropriate system prompts for job market, academic, or D&D queries. Returns structured bullet-point summaries with key findings, sources, and next steps.
---
