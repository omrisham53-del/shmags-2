...
# -*- coding: utf-8 -*-
"""
Tax Incentive Model Generator -- v4 (2026-08-12)
...
2026-08-12-morning-model-fixes.md:
...
def build_global_sheet(wb):
    ...
    section_hdr(ws, 26, "הנחות לפי טכנולוגיה — נקודת קיבולת אחת ממוצעת לכל טכנולוגיה (עודכן 2026-08-12, ראו decisions/log.md)",
    ...
    rowmeta = [
        ...
        (R_COPB, "COP — משאבת חום (בסיסי, תקן מינימלי)", "יחס",
         "DOE FEMP / ASHRAE 90.1-2019", "משאבות חום בלבד — עודכן 2026-08-12, הבסיס כעת משאבת חום סטנדרטית, לא תנור"),
    ...
    R += 1
    notes = [
        "קונסולידציה לנקודת קיבולת אחת (2026-08-12) — כל טכנולוגיה עברה משתי נקודות קיבולת לנקודה "
        ...
        "הישנות. ראו decisions/log.md 2026-08-12.",
        ...
        "של 15-30% (אמצע 22.5%).",
        "CapEx משאבת חום בסיסי — נגזר באנלוגיה לצ'ילר/VSD (2026-08-12): ₪1,050 ÷ 1.20 = ₪875/kW, "
        ...
        "כאן — התא הישן שאליו הפנו הנוסחאות בגיליון הניתוח נמחק בעבר וגרם ל-#REF!, תוקן 2026-08-12.",
        "שחיקת ביצועים — רפי: 0.5%/שנה למשאבות חום וצ'ילרים, 0% למדחסי VSD בורגיים (נצילות נשארת "
        "קבועה עד תקלה). הכיוון בנוסחה תוקן 2026-08-12: העלות עולה עם השחיקה (1+שיעור)^שנה, לא יורדת.",
